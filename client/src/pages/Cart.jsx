...
const Cart = () => {
  ...
  const handleApplyCoupon = async (e) => {
    ...
    try {
      ...
      const discountValue = res.data?.data?.discountValue || res.data?.discountValue || 50; 
      ...
      setCouponMessage({
        type: "error",
        text: err.response?.data?.message || "Invalid coupon code or endpoint not found.",
      });
    } finally {
            ...
            {cart.map((item) => (
              ...
              >
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <p className="mt-1 text-[#E4002B] font-semibold">Rs. {item.price?.toFixed(2)}</p>
                </div>
          ...
          <div className="sticky top-24 rounded-2xl bg-gray-50 p-6 border border-gray-200">
            ...
            <div className="mb-4 space-y-3 border-b border-gray-200 pb-4 text-gray-600">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-gray-900">Rs. {DELIVERY_FEE.toFixed(2)}</span>
              </div>
              {discount > 0 && (
